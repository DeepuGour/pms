...
<div class="properties index content">
    <h3><?= __('Properties') ?></h3>
    <?php echo $this->Html->link(__('Add Property'), ['controller'=>'Properties','action' => 'propertyAdd'], ['class' => 'button']) ?>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="actions">
                        <?= $this->Html->link(__('View'), ['controller'=>'Properties','action' => 'propertyView', $property->id]) ?>
                        <?= $this->Html->link(__('Edit'), ['controller'=>'Properties','action' => 'propertyEdit', $property->id]) ?>
                        <?php if($property->status == 1){
                           echo  $this->Html->link(__('Inactive'), ['controller'=>'Properties','action' => 'propertyInactive', $property->id]);
                        }else{
                           echo $this->Html->link(__('Active'), ['controller'=>'Properties','action' => 'propertyActive', $property->id]);
                        } ?>
                       
                        <?= $this->Form->postLink(__('Delete'), ['controller'=>'Properties','action' => 'propertyDelete', $property->id], ['confirm' => __('Are you sure you want to delete # {0}?', $property->id)]) ?>
                    </td>
                </tr>
                <?php
                   $count++;
